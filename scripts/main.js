...
function getDDAppList(cb){
    $.get("http://api.lpszzb.gov.cndding?key=get_microapp_list ", function (rel) {
...
$(function () {
    ...
    $("#btn-comment").click(function () {
        ...
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "http://api.lpszzb.gov.cnarticle/" + aritcleId + "/aq",
            "method": "POST",
            "headers": {},
            "data": {
                "title": articleTitle,
    ...
    $("#btn-feedback").click(function () {
        ...
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "http://api.lpszzb.gov.cnreport/feedback",
            "method": "POST",
            "headers": {},
            "data": {
                "title": "意见反馈",
...
function getUserInfo(url, callback, callbackGps) {
    ...
    $.get("http://api.lpszzb.gov.cnjsapi-oauth?pwd=sddkhhyy&url=" + url, function (e) {
        var _config = {};
        _config = e;
